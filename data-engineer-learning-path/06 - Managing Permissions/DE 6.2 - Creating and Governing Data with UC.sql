...
-- MAGIC %python
-- MAGIC print(f"{DA.my_new_catalog}")
...
CREATE CATALOG IF NOT EXISTS FIRST_UC_CATALOG;
...
-- Create external table 
 CREATE OR REPLACE TABLE example.ext_example_heartrate_device
...
-- create external  table poiniting to dbfs

CREATE OR REPLACE TABLE dev_custom_location.external_table LOCATION 'dbfs:/user/hive/uc_catalog/external_table' AS
  SELECT * FROM UC_CATALOG.example.heartrate_device;

-- COMMAND ----------

drop table example.ext_example_heartrate_device

-- COMMAND ----------

describe table extended  dev_custom_location.external_table
